Contributing to MasterDemo
============================

The MasterDemo project operates an open contributor model where anyone is
...
The following applies to code changes to the MasterDemo project, and is not to be
confused with overall MASTERDEMO Network Protocol consensus changes.

Whether a pull request is merged into MasterDemo rests with the project merge
...
Patches that change MASTERDEMO consensus rules are considerably more involved than
...
Where a patch set proposes to change the MASTERDEMO consensus, it must have been
...
The project leader is the release manager for each MasterDemo release.
