...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/masterdemo-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/masterdemo-cli.cpp \
           src/masterdemo-tx.cpp \
           src/masterdemo.cpp \
           src/db.cpp \
           ...
           src/qt/masterdemo.cpp \
           src/qt/masterdemostrings.cpp \
...
RESOURCES += src/qt/masterdemo.qrc src/qt/masterdemo_locale.qrc

TRANSLATIONS += src/qt/locale/masterdemo_bg.ts \
                src/qt/locale/masterdemo_de.ts \
                src/qt/locale/masterdemo_en.ts \
                src/qt/locale/masterdemo_es.ts \
                src/qt/locale/masterdemo_fi.ts \
                src/qt/locale/masterdemo_fr.ts \
                src/qt/locale/masterdemo_it.ts \
                src/qt/locale/masterdemo_ja.ts \
                src/qt/locale/masterdemo_pl.ts \
                src/qt/locale/masterdemo_pt.ts \
                src/qt/locale/masterdemo_ru.ts \
                src/qt/locale/masterdemo_sk.ts \
                src/qt/locale/masterdemo_sv.ts \
                src/qt/locale/masterdemo_vi.ts \
                src/qt/locale/masterdemo_zh_CN.ts \
                src/qt/locale/masterdemo_zh_TW.ts
