...
In order to support loading of multiple wallets in masterdemo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is masterdemo.cpp.
...
Changes to masterdemo.cpp
----------------------
masterdemo.cpp is the entry point into masterdemo-qt, and as such, will require some minor modifications to provide hooks for
