...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MASTERDEMO server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MASTERDEMO server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MasterDemo features */
        {"masterdemo", "masternode", &masternode, true, true, false},
        {"masterdemo", "listmasternodes", &listmasternodes, true, true, false},
        {"masterdemo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"masterdemo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"masterdemo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"masterdemo", "masternodedebug", &masternodedebug, true, true, false},
        {"masterdemo", "startmasternode", &startmasternode, true, true, false},
        {"masterdemo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"masterdemo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"masterdemo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"masterdemo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"masterdemo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"masterdemo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"masterdemo", "mnbudget", &mnbudget, true, true, false},
        {"masterdemo", "preparebudget", &preparebudget, true, true, false},
        {"masterdemo", "submitbudget", &submitbudget, true, true, false},
        {"masterdemo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"masterdemo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"masterdemo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"masterdemo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"masterdemo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"masterdemo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"masterdemo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"masterdemo", "checkbudgets", &checkbudgets, true, true, false},
        {"masterdemo", "mnsync", &mnsync, true, true, false},
        {"masterdemo", "spork", &spork, true, true, false},
        {"masterdemo", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"masterdemo", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use masterdemod, or the -server option to masterdemo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> masterdemo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:57059/\n";
}
