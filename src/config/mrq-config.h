/* src/config/masterdemo-config.h.  Generated from masterdemo-config.h.in by configure.  */
/* src/config/masterdemo-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MasterDemo_CONFIG_H

#define MasterDemo_CONFIG_H
...
#define PACKAGE_NAME "MasterDemo Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MasterDemo Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "masterdemo"
