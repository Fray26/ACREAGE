                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MasterDemo") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MASTERDEMO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and masterdemo: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MasterDemo"), this);
    aboutAction->setStatusTip(tr("Show information about MasterDemo"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MASTERDEMO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MASTERDEMO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MASTERDEMO addresses"));
    ...
    openAction->setStatusTip(tr("Open a MASTERDEMO: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MasterDemo help message to get a list with possible MASTERDEMO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MasterDemo client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MASTERDEMO network", "", count));
}
...
{
    QString strTitle = tr("MasterDemo"); // default title
