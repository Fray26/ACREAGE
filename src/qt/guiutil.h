...
/** Utility functions used by the MASTERDEMO Qt UI.
 */
namespace GUIUtil
{
...
// Render MASTERDEMO addresses in monospace font
...
// Parse "masterdemo:" URI into recipient object, return true on successful parsing
