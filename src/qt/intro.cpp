...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MasterDemo"),
     ...
     * override -datadir in the masterdemo.conf file in the default data directory
     * (to be consistent with masterdemod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
