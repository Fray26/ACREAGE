...
public:
    explicit AmountSpinBox(QWidget* parent) : QAbstractSpinBox(parent),
                                              currentUnit(BitcoinUnits::MasterDemo),
    ...
    QSize minimumSizeHint() const
    {
        if (cachedMinimumSizeHint.isEmpty()) {
            ...
            int w = fm.width(BitcoinUnits::format(BitcoinUnits::MasterDemo, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
