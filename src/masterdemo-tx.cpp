...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterDemo masterdemo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  masterdemo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded masterdemo transaction") + "\n" +
                               "  masterdemo-tx [options] -create [commands]   " + _("Create hex-encoded masterdemo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded masterdemo transaction
