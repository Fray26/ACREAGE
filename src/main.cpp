...
#if defined(NDEBUG)
#error "MASTERDEMO cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 10 * COIN;
    } else if (nHeight < 20000  && nHeight >= 5001) {
        nSubsidy = 135 * COIN;
    } else if (nHeight < 33000 && nHeight >= 20001) {
        nSubsidy = 110 * COIN;
    } else if (nHeight < 45000 && nHeight >= 33001) {
        nSubsidy = 100 * COIN;
    } else if (nHeight < 70000 && nHeight >= 45001) {
        nSubsidy = 85 * COIN;
    } else if (nHeight < 90000 && nHeight >= 70001) {
        nSubsidy = 70 * COIN;
    } else if (nHeight < 135000  && nHeight >= 90001) {
        nSubsidy = 100 * COIN;
    } else if (nHeight < 175000  && nHeight >= 135001) {
        nSubsidy = 85 * COIN;
...
{
    RenameThread("masterdemo-scriptch");
